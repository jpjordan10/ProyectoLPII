		...
		<div class="row">
			<div class="col-sm-8">
				...
				<h4>CEHC, Tiene Amplia Experiencia y Gran Respaldo Como Empresa
					Constituida Y Gran Presencia Formal En El Ámbito de La Arqueología
					Además De Estar Actualmente Realizando Diversos Proyectos De
					Consultoría y Trabajo Con Diversas Empresas En Muchos Puntos Del
					Perú.</h4>
				<br>
	...
	<div class="container-fluid bg-grey">
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<br>
				<h4>
					<strong>MISSION:</strong> Brindar un servicio de consultoría
					arqueológica protegiendo y promoviendo los recursos arqueológicos
					para ser integrados a los planes de desarrollo social de nuestro
					país.
				</h4>
				<br>
				<p>
					<strong>VISION:</strong> Nos proyectamos como una Consultoría
					Arqueológica líder en nuestro país, considerando el adecuado manejo
					y protección del Patrimonio Arqueológico conjuntamente con el
		...
		<div class="row slideanim">
			<div class="col-sm-4">
				...
				<p>Se realiza cuando ya se verifico la presencia de un resto
					arqueológico y falta determinar su área exacta.</p>
			</div>
			<div class="col-sm-4">
				<span class="glyphicon glyphicon-list-alt logo-small"></span>
				<h4>TRÁMITE DE CIRA</h4>
				<p>Certificado de Inexistencia de Restos Arqueológicos que
					expide el Ministerio de Cultura, y es requisito indispensable para
					autorizar el inicio de obras civiles, públicas o privadas.</p>
			</div>
			<div class="col-sm-4">
				...
				<p>Documento que es desarrollado cuando se ha identificado,
					durante los trabajos de ingeniería de un proyecto, componentes
		...
		<div class="row slideanim">
			<div class="col-sm-4">
				...
				<p>Establecer un procedimiento de rescate industrial que permita
					una respuesta rápida, eficaz y Segura para evacuar personas en
					espacios confinados</p>
			</div>
			<div class="col-sm-4">
				<span class="glyphicon glyphicon-random logo-small"></span>
				<h4>EXCAVACIONES PARA MEDIR POTENCIA</h4>
				<p>Está especialmentediseñada para ejecutar pantallas en
					terrenos de dureza elevada, realizar excavacionesprofundas o
					resolver situaciones de obras singularesque requieren un método de
					máximafinabilidad y seguridad</p>
			</div>
			<div class="col-sm-4">
				<span class="glyphicon glyphicon-compressed	Try it
 logo-small"></span>
				<h4 style="color: #303030;">PROYECTOS DE PUESTA EN VALOR</h4>
				<p>La puesta en valor de los restos arqueológicos debe estar más
					próxima a la interpretación que a una aparatosa reconstrucción.</p>
			</div>
		</div>
	</div>
		...
		<div id="myCarousel" class="carousel slide text-center"
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<h4>
						La noción de discontinuidad ocupa un lugar mayor en las
						disciplinas históricas. <br>
				...
				<div class="item">
					<h4>
						...
						facilidad la arqueología de nuestro pensamiento. <br>
	...
	<div id="contact" class="container-fluid bg-grey">
		...
		<div class="row">
			<div class="col-sm-5">
				<p>Póngase en contacto con nosotros y nos pondremos en contacto
					con usted en 24 horas.</p>
				<p>
					<span class="glyphicon glyphicon-map-marker"></span> Jr. Toribio
					Rodriguez de Mendoza N° 230 Urb. San Agustín- Lima 7
				</p>
				<p>
