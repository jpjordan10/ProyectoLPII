...
BEGIN
SELECT NUM_PROYECTO, FECHA_REG_PROYECTO, FECHA_ACT_PROYECTO, DEPARTAMENTO_PROYECTO, PROVINCIA_PROYECTO, 
DISTRITO_PROYECTO, DIRECCION_PROYECTO, ETAPA_PROYECTO, COSTO_PROYECTO, MONTO_TOTAL_PROYECTO, 
CAN_MES_TRABAJO, NUM_SOLICITUD
FROM PROYECTO
WHERE COD_TRABAJADOR = P_COD_TRABAJADOR AND ETAPA_PROYECTO = 'CUARTA';
end $$
delimiter ;
...
CAN_MES_TRABAJO, NUM_SOLICITUD 
FROM PROYECTO
WHERE COD_TRABAJADOR = P_COD_TRABAJADOR AND ETAPA_PROYECTO = 'PRIMERA' 
OR ETAPA_PROYECTO = 'SEGUNDA' OR ETAPA_PROYECTO = 'TERCERA';
end $$
delimiter ;

call usp_ProyectosDireccion('T1001');

/*PROYECTOS EN LOS QUE PARTICIPAS*/
delimiter $$
CREATE PROCEDURE usp_ProyectosParticipas(P_COD_TRABAJADOR	CHAR(5))
BEGIN
SELECT P.NUM_PROYECTO, P.FECHA_REG_PROYECTO, FECHA_ACT_PROYECTO, DEPARTAMENTO_PROYECTO, PROVINCIA_PROYECTO, 
DISTRITO_PROYECTO, DIRECCION_PROYECTO, ETAPA_PROYECTO, COSTO_PROYECTO, MONTO_TOTAL_PROYECTO, 
...
WHERE DP.COD_TRABAJADOR = P_COD_TRABAJADOR AND P.ETAPA_PROYECTO = 'CUARTA';
end $$
delimiter ;

call usp_ProyectosParticipas('T1001');
...
FROM PROYECTO P INNER JOIN DETALLE_PROYECTO DP
ON P.NUM_PROYECTO = DP.NUM_PROYECTO
WHERE P.COD_TRABAJADOR = P_COD_TRABAJADOR AND P.ETAPA_PROYECTO = 'PRIMERA' 
OR P.ETAPA_PROYECTO = 'SEGUNDA' OR P.ETAPA_PROYECTO = 'TERCERA';
end $$
delimiter ;

call usp_ProyectosParticipados('T1001');